...
public class MaterialFeedback extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        bt_feedbackSend.setOnClickListener(send -> {
            if(send.getId() == R.id.bt_feedbackSend && (feedback != null ? feedback.length() : 0) > 0 ){
                ...
                // Add this line to print the log
                Log.d("MaterialFeedback", "Feedback: " + feedback);
    ...
    // Add a new method to print the reviews
    private void printReview(String review) {
        Log.d("MaterialFeedback", "Review: " + review);
    }
}
